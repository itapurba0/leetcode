...
🔴 **Hard** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/longest-valid-parentheses/)
...
**My Solution:** [32-Longest-Valid-Parentheses.py](./32-Longest-Valid-Parentheses.py)
